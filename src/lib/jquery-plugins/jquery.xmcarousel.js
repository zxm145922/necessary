...
(function($) {
    ...
    XmCarousel.prototype = {
        ...
        createDom: function(container) {
            ...
            let btn = this.isButton ? `<div class="prev"></div>
					<div class="next"></div>` : "",
            ...
            $(container).hover(function() { $(".prev, .next", $(container)).css("display", "block") }, function() { $(".prev, .next", $(container)).css("display", "none") })
            this.next.css({
        ...
        move: function() {
            ...
            // 小圆点样式切换
            this.circles.eq(this.currentIndex).css({
                display: "inline-block",
                width: "9px",
                height: "9px",
                margin: "10px",
            ...
            this.circles.eq(this.nextIndex).css({
                display: "inline-block",
                width: "13px",
                height: "13px",
                margin: "10px",
